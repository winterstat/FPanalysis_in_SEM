...
model_2a_results_2 <- readRDS(here::here("Online-Supplement","Data-Files" ,"model_2A_fp_con_2.rds"))
model_2a_results_3 <- readRDS(here::here("Online-Supplement","Data-Files" ,"model_2A_fp_con_3.rds"))
model_2a_results_4 <- readRDS(here::here("Online-Supplement","Data-Files" ,"model_2A_fp_con_4.rds"))
...
fp_values_2 <- sapply(model_2a_results_2, function(x){
...
fp_values_3 <- sapply(model_2a_results_3, function(x){
...
fp_values_4 <- sapply(model_2a_results_4, function(x){
...
ggsave(plot = plot_1, path = here::here("Online-Supplement","Plots", "Study Two"), 
       filename = 'max-iterations-fp-study-2-condition_1-model-2A.png', width = 10, height = 8,
       units = 'in')
...
ggsave(plot = plot_2, path = here::here("Online-Supplement","Plots", "Study Two"), 
       filename = 'max-iterations-fp-study-2-condition_2-model-2A.png', width = 10, height = 8,
       units = 'in')
...
ggsave(plot = plot_3, path = here::here("Online-Supplement","Plots", "Study Two"), 
       filename = 'max-iterations-fp-study-2-condition_3-model-2A.png', width = 10, height = 8,
       units = 'in')
...
ggsave(plot = plot_4, path = here::here("Online-Supplement","Plots", "Study Two"), 
       filename = 'max-iterations-fp-study-2-condition_4-model-2A.png', width = 10, height = 8,
       units = 'in')
