...
# saving the results
saveRDS(fp.size.results_1, file = here::here("Online-Supplement","Data-Files", "study3_poscor_model_1_dataspacesize_badness.RDS"))

saveRDS(res_pos_model_1, file = here::here("Online-Supplement", "Data-Files", "results_poscor_study_3_model_1_dataspacesize_badness.RDS"))
...
# saving the results
saveRDS(fp.size.results_2, file = here::here("Online-Supplement", "Data-Files", "study3_poscor_model_2_dataspacesize_badness.RDS"))
saveRDS(res_pos_model_2, file = here::here("Online-Supplement","Data-Files", "results_poscor_study_3_model_2_dataspacesize_badness.RDS"))
...
# saving the results
saveRDS(fp.size.results_3, file = here::here("Online-Supplement", "Data-Files", "study3_poscor_model_3_dataspacesize_badness.RDS"))
saveRDS(res_pos_model_3, file = here::here("Online-Supplement","Data-Files", "results_poscor_study_3_model_3_dataspacesize_badness.RDS"))
...
# saving the results
saveRDS(fp.size.results_1, file = here::here("Online-Supplement","Data-Files", "study3_allcor_model_1_dataspacesize_badness.RDS"))
saveRDS(res_all_model_1, file = here::here("Online-Supplement","Data-Files", "results_allcor_study_3_model_1_dataspacesize_badness.RDS"))
...
# saving the results
saveRDS(fp.size.results_2, file = here::here("Online-Supplement","Data-Files", "study3_allcor_model_2_dataspacesize_badness.RDS"))
saveRDS(res_all_model_2, file = here::here("Online-Supplement","Data-Files", "results_allcor_study_3_model_2_dataspacesize_badness.RDS"))
...
# saving the results
saveRDS(fp.size.results_3, file = here::here("Online-Supplement","Data-Files", "study3_allcor_model_3_dataspacesize_badness.RDS"))
saveRDS(res_all_model_3, file = here::here("Online-Supplement","Data-Files", "results_allcor_study_3_model_3_dataspacesize_badness.RDS"))
# clean work space--------------------------------------------------------------
rm(list = ls())
...
res_pos_model_1 <- readRDS(here::here("Online-Supplement","Data-Files", "results_poscor_study_3_model_1_dataspacesize_badness.RDS"))
res_all_model_1 <- readRDS(here::here("Online-Supplement","Data-Files", "results_allcor_study_3_model_1_dataspacesize_badness.RDS"))

res_pos_model_2<- readRDS(here::here("Online-Supplement","Data-Files", "results_poscor_study_3_model_2_dataspacesize_badness.RDS"))
res_all_model_2 <- readRDS(here::here("Online-Supplement","Data-Files", "results_allcor_study_3_model_2_dataspacesize_badness.RDS"))

res_pos_model_3 <- readRDS(here::here("Online-Supplement","Data-Files", "results_poscor_study_3_model_3_dataspacesize_badness.RDS"))
res_all_model_3 <- readRDS(here::here("Online-Supplement","Data-Files", "results_allcor_study_3_model_3_dataspacesize_badness.RDS"))
#-------------------------------------------------------------------------------
...
saveRDS(table_11, file = here::here("Online-Supplement","Data-Files", "table_11_badness.RDS"))
saveRDS(table_22, file = here::here("Online-Supplement","Data-Files", "table_22_badness.RDS"))
saveRDS(table_33, file = here::here("Online-Supplement","Data-Files", "table_33_badness.RDS"))

saveRDS(total_11, file = here::here("Online-Supplement","Data-Files", "total_11_badness.RDS"))
saveRDS(total_22, file = here::here("Online-Supplement","Data-Files", "total_22_badness.RDS"))
saveRDS(total_33, file = here::here("Online-Supplement","Data-Files", "total_33_badness.RDS"))
...
results_full_1 %>%
  ...
  scale_fill_manual(name = 'Model',
                   values = c('Model 3A' = "#276419",
                              'Model 3B' = "#8e0152", 
                              'Model 3C' = "#b2182b")) +
  scale_linetype_manual(
    name = "Model",
    values = c("Model 3A" = "solid", "Model 3B" = "dashed", "Model 3C" = "dotted")) +
...
filename = 'Fit-positive-LL-dataspace-study-3-model-1-badness.png', width = 10, height = 8,
       units = 'in')
...
filename = 'Fit-all-LL-dataspace-study-3-model-1-badness.png', width = 10, height = 8,
       units = 'in')
...
filename = 'Fit-positive-LL-dataspace-study-3-model-2-badness.png', width = 10, height = 8,
units = 'in')
...
filename = 'Fit-all-LL-dataspace-study-3-model-2-badness.png', width = 10, height = 8,
units = 'in')

#--------------------------------------------------------------------------------
results_full_3 %>%
  pivot_longer(cols = cfi:logl, names_to = "index") %>%
  filter(size <= 1e4) %>% # selecting fit values less that the value specified
  group_by(model, cor, size, index, bounds, ident) %>%
  mutate(model = factor(model, levels = c(1, 2, 3),  labels = c('Model 3A', 'Model 3B', 'Model 3C')),
...
filename = 'Fit-positive-LL-dataspace-study-3-model-3-badness.png', width = 10, height = 8,
units = 'in')
...
filename = 'Fit-all-LL-dataspace-study-3-model-3-badness.png', width = 10, height = 8,
units = 'in')
#-------------------------------------------------------------------------------
