...
comparison <- study2_conditions %>% filter(bounds == "none", mlit == 150, model == 1)
...
#   1 Always-taker     511606     -33248.   -33248.    0.441      0.00198    0.00196 -0.0000156
# 2 Complier (Lunit) 128826     -32887.   -33278. -391.         0.278      0.00179 -0.276    
# 3 Defier (Lref)      7546     -33373.   -32508.  865.         0.00252    0.666    0.664    
# 4 Never-taker      352022     -32652.   -32470.  182.         0.506      0.714    0.208  

save(logl_all_2, file = here::here("Online-Supplement","Data-Files","logl_all_2A.RDS"))
#-------------------------------------------------------------------------------
