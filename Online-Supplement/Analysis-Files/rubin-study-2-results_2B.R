...
comparison <- study2_conditions %>% filter(bounds == "none", mlit == 150, model == 2)
...
# 1 Always-taker      42259     -32962.   -32982.  -19.9        0.142      0.112 -0.0297
# 2 Complier (Lunit)  72343     -32490.   -32990. -500.         0.626      0.119 -0.508 
# 3 Defier (Lref)     33593     -32771.   -32633.  137.         0.444      0.501  0.0567
# 4 Never-taker      851805     -32356.   -32494. -138.         0.745      0.593 -0.152 


save(logl_all_2, file = here::here("Online-Supplement","Data-Files","logl_all_2B.RDS"))
#-------------------------------------------------------------------------------
