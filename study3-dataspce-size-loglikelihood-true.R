...
cfi.fp_1 <- function(fits, cutoff = .51) {
  ...
  return(mean(fits >= cutoff,  na.rm = TRUE))
}
...
cfi.fp_2 <- function(fits, cutoff = .431) {
  ...
  return(sum(fits >= cutoff, na.rm = TRUE)/sum(!is.na(fits)))
}
...
# function to get the log likelihood with > -36,996------------------------------

logl.fp_2 <- function(fits, cutoff = -36996){
...
# saving the results
saveRDS(fp.size.results_1, file = here::here("Online-Supplement","Data-Files", "study3_all_model_1_true_dataspacesize.RDS"))

saveRDS(res_all_model_1, file = here::here("Online-Supplement","Data-Files", "results_all_study_3_model_1_true_dataspacesize.RDS"))
...
# saving the results
saveRDS(fp.size.results_2, file = here::here("Online-Supplement","Data-Files", "study3_all_model_2_true_dataspacesize.RDS"))

saveRDS(res_all_model_2, file = here::here("Online-Supplement","Data-Files", "results_all_study_3_model_2_true_dataspacesize.RDS"))
...
# saving the results
saveRDS(fp.size.results_3, file = here::here("Online-Supplement","Data-Files", "study3_all_model_3_true_dataspacesize.RDS"))

saveRDS(res_all_model_3, file = here::here("Online-Supplement","Data-Files", "results_all_study_3_model_3_true_dataspacesize.RDS"))
# clean work space
rm(list = ls())
...
results_full_3 %>%
  ...
  scale_fill_manual(name = 'Model',
                    values = c('Model 3A' = "#276419",
                               'Model 3B' = "#8e0152", 
                               'Model 3C' = "#b2182b")) + scale_linetype_manual(
    name = "Model",
    values = c("Model 3A" = "solid", "Model 3B" = "dashed", "Model 3C" = "dotted")
  ) +
  scale_x_continuous(breaks = seq(0, 1e4, 2e3),
...
saveRDS(table_111, file = here::here("Online-Supplement", "Data-Files", "table_111_true.RDS"))

saveRDS(table_222, file = here::here("Online-Supplement", "Data-Files", "table_222_true.RDS"))

saveRDS(table_333, file = here::here("Online-Supplement", "Data-Files", "table_333_true.RDS"))

saveRDS(total_111, file = here::here("Online-Supplement","Data-Files", "total_111_true.RDS"))

saveRDS(total_222, file =  here::here("Online-Supplement","Data-Files", "total_222_true.RDS"))

saveRDS(total_333, file =  here::here("Online-Supplement","Data-Files", "total_333_true.RDS"))
#-------------------------------------------------------------------------------
